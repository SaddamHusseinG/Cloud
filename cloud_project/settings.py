...
# DEBUG is True locally, but will be False on Render
...
# Database
# Uses the Neon PostgreSQL database on Render, and local SQLite otherwise.
...
if USE_S3:
    ...
    # Configure Django's default storage to use S3 for media files.
    STORAGES = {
        "default": {
            "BACKEND": "storages.backends.s3boto3.S3Boto3Storage",
            "OPTIONS": {"location": "media"},
        },
        # Static files are handled by WhiteNoise, not S3.
